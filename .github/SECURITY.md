...
[**Report a vulnerability**](https://github.com/frenck/python-gotailwind/security/advisories/new)
...
- Issues in the Tailwind device firmware itself; please report those directly
  to [Tailwind](https://gotailwind.com/).
- Denial-of-service or data-exposure conditions resulting from malformed or
  hostile responses from a Tailwind device the client is explicitly pointed
  at. This library assumes the configured endpoint is trusted.

## Scope

This security policy covers the `gotailwind` Python package published on
[PyPI](https://pypi.org/project/gotailwind/) and its source code in this
repository.
